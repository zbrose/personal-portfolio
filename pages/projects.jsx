                ...
                <div className="aside">
                    ...
                    <div className="small-container">
                        ...
                        <div className="flex-box">
                            <div className="img-wrapper"><Image src='/icons/6js.png' alt='the javascript logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/bhtml5.png' alt='the html 5 logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/7css.png' alt='the css3 logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/9node-js.png' alt='the node js logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/aexpress.png' alt='the express logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/mongodb (1).png' alt='the mongodb logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/2react.png' alt='the react logo' width={50} height={50}/></div>
                        </div>
                        <div>
                ...
                <div className="aside">
                    ...
                    <div className="small-container">
                        ...
                        <div className="flex-box">
                            ...
                            <div className="img-wrapper"><Image src='/icons/bhtml5.png' alt='the html 5 logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/7css.png' alt='the css3 logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/bootstrap.png' alt='the bootstrap logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/9node-js.png' alt='the node js logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/aexpress.png' alt='the express logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/mongodb (1).png' alt='the mongodb logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/2react.png' alt='the react logo' width={50} height={50}/></div>
                ...
                <div className="aside">
                    ...
                    <div className="small-container">
                        ...
                        <div className="flex-box">
                            ...
                            <div className="img-wrapper"><Image src='/icons/bootstrap.png' alt='the bootstrap logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/9node-js.png' alt='the node js logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/postgresql.png' alt='the postgres logo' width={50} height={50}/></div>
                            <div className="img-wrapper"><Image src='/icons/aexpress.png' alt='the express logo' width={50} height={50}/></div>
                        </div>
                        <div>
